...
function buildingAnAntArmy(hp: number): number {
  let count = 0;
  const offensePower = [5, 3, 1];
...
console.log(buildingAnAntArmy(23));
console.log(buildingAnAntArmy(999));
